...
class API extends REST {
    ...
    private function listPlaces(){
        ...
        $query = "SELECT DISTINCT p.place_id, p.name, p.image, p.address, p.fee, p.status, p.phone, p.website, p.description, p.lat, p.lng, p.last_update
	...
	private function insertPlace(){
		...
		$column_names = array('name', 'image', 'address', 'fee','status','phone','website','description','lat','lng','last_update');
		$table_name = 'place';
		$pk = 'place_id';
