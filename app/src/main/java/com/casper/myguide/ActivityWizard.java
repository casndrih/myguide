...
public class ActivityWizard extends AppCompatActivity {
    ...
    private String about_description_array[] = {
            ...
            "Select the day, Book your flight with Air New Guinea. We making it easier!",
            "Safe and Comfort travel with our detailed guides. Never get confused.",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefser = new Prefser(ActivityWizard.this);
