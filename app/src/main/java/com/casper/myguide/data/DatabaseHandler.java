...
import com.casper.myguide.model.Category;
import com.casper.myguide.model.Images;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "id16877257_myguide";
    ...
    public void insertListPlaceAsync(List<Place> modelList) {
        ...
        sql = sql + "("+KEY_PLACE_ID+", "+KEY_NAME+","+KEY_IMAGE+", "+KEY_ADDRESS+", "+KEY_FEE +", "+KEY_STATUS +", "+KEY_PHONE +", "
        ...
        for (Place p : modelList) {
            ...
            stmt.bindString(5, p.fee);
            stmt.bindString(6, p.status);
            stmt.bindString(7, p.phone);
            stmt.bindString(8, p.website);
            stmt.bindString(9, p.description);
            stmt.bindDouble(10, p.lng);
            stmt.bindDouble(11, p.lat);
            stmt.bindDouble(12, p.distance);
            stmt.bindDouble(13, p.last_update);
            stmt.execute();
            stmt.clearBindings();
    ...
    private Place getPlaceByCursor(Cursor cur){
        ...
        p.fee         = cur.getString(cur.getColumnIndex(KEY_FEE));
        p.status      = cur.getString(cur.getColumnIndex(KEY_STATUS));
